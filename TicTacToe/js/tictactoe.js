...
function placeXorO(squareNumber) {
    ...
    //Returning true is needed for our comuptersTurn() function to work 
    return true;
    }
...
function drawWinLine (coordX1, coordY1, coordX2, coordY2) {
    ...
    y2 = coordY2,
    //This variable sores temporary x axis data we update in our animation loop
    x = x1,
...
function resetGame() {
    ...
    for (let i = 0; i < 9; i++) {
        //This variable gets the html elementof i.
